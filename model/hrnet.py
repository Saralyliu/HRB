...
def _hrnet(arch, pretrained, progress, **kwargs):
    try:
        from model.initmodel.hrnet_config import MODEL_CONFIGS
    except ImportError:
        from model.initmodel.hrnet_config import MODEL_CONFIGS
    ...
    if pretrained:
        ...
        model_path = '/home/liuyu/code/SHSNet/model/initmodel/hrnetv2_w48_imagenet.pth'
